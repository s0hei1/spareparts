...
from apps.spareparts.buisness_logic_layer.tag.tag_schema import TagRead, TagCreate, TagUpdate, TagDeleteRead
from apps.spareparts.data.models.sparepart import Tag
