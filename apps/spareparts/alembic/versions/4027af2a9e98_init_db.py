...
Revision ID: 4027af2a9e98
Revises: 
Create Date: 2025-06-11 14:14:27.780318
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['spare_part_type_property_id'], ['spare_part_properties.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
